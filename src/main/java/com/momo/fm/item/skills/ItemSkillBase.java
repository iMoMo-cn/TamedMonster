package com.momo.fm.item.skills;

import com.momo.fm.MoMoFramework;
import com.momo.fm.item.ItemBase;
import com.momo.fm.util.CommonFunctions;
import com.momo.fm.util.IDLSkillNBT;
import com.momo.fm.util.MessageDef;
...
import static com.momo.fm.util.CommonDef.G_SKY;
import static com.momo.fm.util.CommonDef.TICK_PER_SECOND;
import static com.momo.fm.util.CommonFunctions.SendMsgToPlayer;
import static com.momo.fm.util.CommonFunctions.isShiftPressed;
import static com.momo.fm.util.MessageDef.getSkillCastKey;
