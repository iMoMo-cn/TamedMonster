package com.momo.fm.entity.creatures.models;

import com.momo.fm.entity.creatures.friendlyMonster.EntityMagmaCubeFM;
...
public class ModelMagmaCubeFM extends ModelBase {
    ModelRenderer[] segments = new ModelRenderer[8];
    ModelRenderer core;

    public ModelMagmaCubeFM()
    {
    ...
    {
        EntityMagmaCubeFM entitymagmacube = (EntityMagmaCubeFM) entitylivingbaseIn;
