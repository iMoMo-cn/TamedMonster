package com.momo.tamedmonster.entity.projectiles;
...
public class EntityIdlProjectile extends Entity implements IProjectile {
    ...
    protected EntityIdlProjectile(World worldIn, ProjectileArgs args) {
        super(worldIn);
        this.args = args;
        //MoMoFramework.Log("bullet created %s, args = %s", getUniqueID(), this.args);
    }
...
//    }
    ...
    {
        //MoMoFramework.Log("Bullet pos update:%s", getPositionEyes(0));
    ...
    protected boolean isFireballFiery()
    {
        if (args == null)
        {
            //MoMoFramework.LogWarning("Args not found for bullet");
            return false;
        }
        return args.burning;
    }
...
//    }
    ...
    /**
     * Called when this EntityIdlProjectile hits a blockBush or entity.
     */
    protected void onImpact(RayTraceResult result)
    {
        //MoMoFramework.Log("bullet impact %s", getUniqueID());
