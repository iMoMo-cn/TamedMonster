...
public class EntityMagmaCubeFM extends EntityNetherFriendlyMonster{
    public float squishAmount;
    public float squishFactor;
    public float prevSquishFactor;
    private boolean wasOnGround;

    public EntityMagmaCubeFM(World worldIn) {
        super(worldIn);
    ...
    protected void initEntityAI()
    {
        ...
        this.tasks.addTask(2, new AISlimeTempt(this, ModItems.NETHER_STEW, false));
    ...
    public void onUpdate()
    {
        ...
        if (this.onGround && !this.wasOnGround)
        {
            ...
            for (int j = 0; j < i * 8; ++j)
            {
                ...
                world.spawnParticle(EnumParticleTypes.FLAME, d0, this.getEntityBoundingBox().minY, d1, 0.0D, 0.0D, 0.0D);
            }
    ...
    public static void registerFixesMagmaCubeFM(DataFixer fixer) { EntityLiving.registerFixesMob(fixer, EntityMagmaCubeFM.class); }
    ...
    protected SoundEvent getHurtSound(DamageSource damageSourceIn) { return SoundEvents.ENTITY_MAGMACUBE_HURT; }

    protected SoundEvent getDeathSound() { return SoundEvents.ENTITY_MAGMACUBE_DEATH; }

    protected SoundEvent getSquishSound() { return SoundEvents.ENTITY_MAGMACUBE_SQUISH; }

    protected SoundEvent getJumpSound() { return SoundEvents.ENTITY_MAGMACUBE_JUMP; }

    @Nullable
    protected ResourceLocation getLootTable() { return ModLootList.ENTITY_MAGMA_CUBE_FM; }
    ...
    protected void jump()
    {
        this.motionY = (double)(0.42F + 1.0F * 0.1F);
    ...
    {
        this.motionY = (double)(0.22F + 1.0F * 0.05F);
        this.isAirBorne = true;
    }

    @Nullable
    @Override
    public EntityAgeable createChild(EntityAgeable ageable) { return new EntityMagmaCubeFM(this.world); }
    ...
    static class AISlimeTempt extends EntityAIBase
    {
        ...
        public void updateTask()
        {
            ...
            if (this.temptedEntity.getDistanceSq(this.temptingPlayer) < 6.25D)
            {
                ...
                ((SlimeMoveHelper) this.temptedEntity.getMoveHelper()).setSpeed(5.0D);
            }
        }
    }
    ...
    {
        private final EntityMagmaCubeFM slime;
        private float chosenDegrees;
        private int nextRandomizeTime;

        public AISlimeFaceRandom(EntityMagmaCubeFM slimeIn)
        {
            this.slime = slimeIn;
            setMutexBits(2);
        }
        ...
        public void updateTask()
        {
            ...
            ((EntityMagmaCubeFM.SlimeMoveHelper)this.slime.getMoveHelper()).setDirection(this.chosenDegrees, false);
        }
    }
    ...
    static class AISlimeFloat extends EntityAIBase
    {
        ...
        public AISlimeFloat(EntityMagmaCubeFM slimeIn)
        {
            this.slime = slimeIn;
        ...
        public void updateTask()
        {
            ...
            ((EntityMagmaCubeFM.SlimeMoveHelper)this.slime.getMoveHelper()).setSpeed(1.2D);
        }
    }
    ...
    static class AISlimeHop extends EntityAIBase
    {
        ...
        public AISlimeHop(EntityMagmaCubeFM slimeIn)
        {
            this.slime = slimeIn;
            setMutexBits(5);
        }
        ...
        public void updateTask()
        {
            ((EntityMagmaCubeFM.SlimeMoveHelper)this.slime.getMoveHelper()).setSpeed(2.0D);
        }
    }
    ...
    static class SlimeMoveHelper extends EntityMoveHelper
    {
        ...
        public SlimeMoveHelper(EntityMagmaCubeFM slimeIn)
        {
            super(slimeIn);
            this.slime = slimeIn;
