package com.momo.tamedmonster.blocks.tileEntity.orbs;
			...
			for(int y = 1; y <= depth; y++)
			{
				...
				if (!isDownEmpty && isCenterEmpty)
				{
					...
					for (int i = 0; i <= 3; i++)
					{
						...
						{
							//	At first I want to make the blockBush imitate a nearby blockBush
...
//		MoMoFramework.Log("Spawning:"+event.getEntityLiving().getName());
...
//				MoMoFramework.Log("Stopped spawning:"+event.getEntityLiving().getName());
//				return;
//			}
//		}
//	}
