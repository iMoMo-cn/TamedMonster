package com.momo.tamedmonster.util;

import com.momo.tamedmonster.MoMoFramework;
import com.momo.tamedmonster.meta.MetaUtil;
import com.momo.tamedmonster.entity.creatures.EntityModUnit;
...
public class EntityUtil {
    ...
    public static boolean ApplyBuff(EntityLivingBase livingBase, Potion potion, int level, float seconds)
    {
        ...
        {
            MoMoFramework.LogWarning("Trying to apply illegal potion");
            return false;
        }
    ...
    public static boolean isOtherworldAggression(EntityLivingBase creature)
    {
        ...
        String modid = er.getContainer().getModId();
        //MoMoFramework.Log("Atk ER.modid is %s, name is %s", modid, er.getRegistryName());
    ...
    public static boolean boostAttr(EntityLivingBase creature, IAttribute attrType, float amountFixed, UUID uuid)
    {
        ...
        //MoMoFramework.Log("Value:%s: %.2f->%.2f", modifier.getName(), valueBefore, valueAfter);
        return true;
    }
